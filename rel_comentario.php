...
function rel_print(){
	nova = window.open('rel_comentario_print.php?idtrabalho=<?php echo $idtrabalho; ?>','relatorio print','width=500,height=400,toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,copyhistory=yes,resizable=no');
}
</script>
<body>
<?php
	...
	<table  width=\"463\" align='center' >
				<tr><td><h1>Coment&aacute;rios sobre o trabalho ".$idtrabalho."</h1></td></tr>
	</table><br>";
