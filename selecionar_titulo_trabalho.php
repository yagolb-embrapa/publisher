...
&nbsp;
<h1>Atualizar título de trabalho</h1>
<p>Selecionar trabalho específico
  ...
  <input name="txtAno" id="txtAno" type="text" size="4" maxlength="4" onKeyPress="mascara(this,soNumeros);">
   &nbsp;
   <input type="button" name="Submit2" value="Selecionar Trabalho" onClick="trabSelector = dhtmlwindow.open('listDiv','ajax','listTrabalhos_Ano.php?dest=6&ano='+document.getElementById('txtAno').value,'Selecionar trabalho','width=400px,height=280px,center=1,scrolling=1');">
</p>
</td>
</tr>
<tr><td>
