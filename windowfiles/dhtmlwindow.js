...
imagefiles:['windowfiles/mouseover_min.png', 'windowfiles/mouseover_close.png', 'windowfiles/active_min.png', 'windowfiles/resize.gif'], //Path to 4 images used by script, in that order (alterado pras minhas imagens pessoais do estilo Tiger)
...
ajax_loadpage:function(page_request, t){
	...
	var final = unescape(page_request.responseText.replace(/\+/g," "));
	t.contentarea.innerHTML=page_request.responseText
	this.extraiScript(final);
	}
},
